...
class Hostinger_Ai_Assistant_Errors {
	...
	public function __construct() {
		$this->error_messages = array(
			...
			'server_error'     => array(
				'default' => __( 'We apologize for the inconvenience. The AI content generation process encountered a server error. Please try again later, and if the issue persists, kindly contact our support team for assistance.', 'hostinger-ai-assistant' ),
			),
		);
	}
